...
class Client(oic.Client):
    ...
    def create_authn_request(self, session, acr_value=None):
        ...
        if not "nonce" in self.behaviour or self.behaviour["nonce"]:
    ...
    def callback(self, response, method="POST"):
        """
        ...
        inforesp = self.do_user_info_request(state=authresp["state"], method=method)
